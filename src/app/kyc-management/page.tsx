...
import SearchAndFilters from '@/components/kyc-management/SearchAndFilters';
      ...
      <div>
        ...
        <div className="bg-white rounded-lg rounded-tl-none border border-gray-200">
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 p-4 border-b border-gray-200">
            <div>
              <h1 className="text-2xl font-semibold text-black">KYC / Compliance Management</h1>
            </div>
          ...
          <div className="p-4">
            <KycTable activeTab={activeTab} searchQuery={searchQuery} filters={filters} currentPage={currentPage} onTotalPagesChange={setTotalPages} />
            {totalPages > 0 && (
